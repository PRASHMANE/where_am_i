...
def dashboard():
    ...
    with col2:
        ...
        img1 = Image.open("/Users/prashmane/Documents/where_am_i/data1/face_recgnition1.jpg")
        st.image(img1, use_container_width=True)
        st.markdown("<div class='caption'>Face Recognition Output</div>", unsafe_allow_html=True)
        img2 = Image.open("/Users/prashmane/Documents/where_am_i/data1/retinaface1.jpg")
    ...
    with col3:
        img_before = Image.open("/Users/prashmane/Documents/where_am_i/data1/face_count1.jpg")
        st.image(img_before, use_container_width=True)
        st.markdown("<div class='caption'>Before RGB Filter</div>", unsafe_allow_html=True)
    with col4:
        img_after = Image.open("/Users/prashmane/Documents/where_am_i/data1/face_count.jpg")
    ...
    try:
        arch_img = Image.open("/Users/prashmane/Documents/where_am_i/data1/phase3_architecture.png")
        st.image(arch_img, caption="RetinaFace + ArcFace System Architecture", use_container_width=True)
    except:
        st.info("Add an architecture diagram at `/data1/phase3_architecture.png` to display it here.")
